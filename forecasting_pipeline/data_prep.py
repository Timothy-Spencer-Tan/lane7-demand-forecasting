...
def build_stylecolor_panel(
    ...
    """
    from forecasting_pipeline.allocation import build_stylecolor_demand, get_standalone_skus
...
def build_stylecode_panel(
    ...
    """
    from forecasting_pipeline.stylecode_allocation import build_stylecode_demand
