...
from lane7_forecast.data_prep    import load_gold_tables, build_panel
...
from lane7_forecast.evaluation   import walk_forward_cv, select_best_model
from lane7_forecast.models       import SEGMENT_MODEL_ROSTER, train_ml_model
from lane7_forecast.forecasting  import generate_forecasts, write_forecasts, append_forecasts
...
def run_hierarchical_forecasts(
    ...
    """
    from lane7_forecast.forecasting import write_forecasts, append_forecasts
    from lane7_forecast.allocation  import allocate_to_sku, validate_allocation
...
def run_v7_1_prep(
    ...
    from lane7_forecast.allocation import compute_size_shares_v71
