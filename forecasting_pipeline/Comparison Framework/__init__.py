...
from forecasting_pipeline.segmentation import segment_skus, attach_segment, get_segment_skus
...
from forecasting_pipeline.evaluation import (
...
from forecasting_pipeline.forecasting import (
    generate_forecasts, write_forecasts, append_forecasts, build_future_features,
)
from forecasting_pipeline.pipeline import (
    run_data_prep, run_cv, run_forecasts, run_simulation, build_simulation_summaries,
)

# v6
from forecasting_pipeline.pipeline import run_hierarchical_prep, run_hierarchical_forecasts
...
try:
    from forecasting_pipeline.holdout_v6 import run_v6_holdout, compare_v6_vs_v52
except Exception:
    pass

# v6.2
from forecasting_pipeline.forecast_adjustments import (
...
# v7
from forecasting_pipeline.pipeline import run_v7_prep, run_v7_forecasts
...
# v7.1 (guarded)
try:
    from forecasting_pipeline.pipeline import run_v7_1_prep, run_v7_1_forecasts
except Exception: pass
try:
    from forecasting_pipeline.allocation import compute_size_shares_v71, allocate_to_sku_v71
except Exception: pass
try:
    from forecasting_pipeline.stylecode_allocation import (
...
# v7.2 (guarded)
try:
    from forecasting_pipeline.pipeline import run_v7_2_ablation
except Exception: pass
try:
...
# v7.3 (guarded)
try:
    from forecasting_pipeline.pipeline import run_v7_3_segmented
except Exception: pass
try:
...
# v7.4 Production Candidate
try:
    from forecasting_pipeline.pipeline import run_v7_4_production
except Exception: pass
try:
...
# v7.5 additions
try:
    from forecasting_pipeline.backtest_calibration_v75 import (
    ...
    pass
try:
    from forecasting_pipeline.production_outputs_v75 import (
...
# v7.6 additions
try:
    from forecasting_pipeline.global_bias_control_v76 import (
    ...
    pass
try:
    from forecasting_pipeline.production_outputs_v76 import (
